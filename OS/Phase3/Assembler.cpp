...
void Assembler::checkrd()
{
    ...
    cout << "COULD NOT ASSEMBLE: Invalid Range for Destination Register" << endl;
    exit(0);
}//checkrd
...
void Assembler::checkrs()
{
    ...
    cout << "COULD NOT ASSEMBLE: Invalid Range for Source Register" << endl;
    exit(0);
}//checkrs
...
void Assembler::checkaddr()
{
    ...
    cout << "COULD NOT ASSEMBLE: Invalid Range for Address" << endl;
    exit(0);
}//checkaddr
...
void Assembler::checkcon()
{
    ...
    cout << "COULD NOT ASSEMBLE: Invalid Range for Constant Value" << endl;
    exit(0);
}//checkcon
